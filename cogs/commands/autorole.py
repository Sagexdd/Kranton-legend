...
class BasicView(discord.ui.View):
    ...
    async def interaction_check(self, interaction: discord.Interaction):
        if interaction.user.id != self.ctx.author.id and interaction.user.id not in [1328025198758461440]:
...
class AutoRole(commands.Cog):
    ...
    async def _ar_config(self, ctx):
        ...
        if data:
            ...
            emb.add_field(name="<:icons_human:1343922201933385749> __Humans__", value=hums, inline=False)
            emb.add_field(name="<:verified_bot:1345357407320150158> __Bots__", value=bos, inline=False)
